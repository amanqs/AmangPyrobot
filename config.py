...
class Var:
    ...
    ALIVE_PIC = getenv("ALIVE_PIC", "https://telegra.ph/file/b930d00402db6611bd223.jpg")
    ALIVE_TEXT = getenv("ALIVE_TEXT", "Hey, Saya AmangPyrobot Dibuat dengan basis pyrogram versi terbaru")
